...
public class Response<T> : Response {
    ...
    public static implicit operator Response<T>(RestResponse<T> restResponse) => FromRestResponse(restResponse);
...
public class Response {
    ...
    public static implicit operator Response(RestResponse restResponse) => FromRestResponse(restResponse);
}